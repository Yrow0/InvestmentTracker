...
namespace InvestmentTrackerAPI.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public CategoriesController(InvestmentTrackerContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        {
            return _mapper.Map<List<CategoryResponse>>(await _context.Categories.ToListAsync());
        }
